...
**Architecture:** 使用 `go.work` 聚合 `modules/mcpkit`、`services/vcenter`、`services/ces` 三个 module；服务 module 通过 `require github.com/<org>/<repo>/modules/mcpkit v0.0.0` 依赖共享库，并由 workspace 在本地解析源代码。
